...
**A session a change bought and did not get costs one line** — say so and why, on the change's pull request or issue. **That line names no successor.** One saying a later session will run it is a deferral wearing a decline's words, and it binds whoever it names to nothing; the decline is the record that none ran and why, written about this change in the past tense, leaving nobody holding it. **So does a change that concluded it bought none**, unless that change was purely mechanical: the conclusion is written down with its reason, because *nothing was bought* and *the trigger never named my case* are the same silence from outside, and the second is what a missed session actually looks like from inside. The mechanical cases above are the one exception, having never reached the question. No session blocks a pull request by existing or by being skipped; this is not a gate and not a stage of a review.
