...
- **A run needs a repository tree of its own and you are about to build it — this cell's, or one arm of a cold-seat A/B** → `references/isolation.md`: building from the change's content without its history, and the records that leak what is under test.
