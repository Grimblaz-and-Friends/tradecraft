...
**A bought review is one round** — every stage the chosen lane names and the fix batch, once each — and what reads the result after it is use, not a further pass: [a bounded trial, scored](https://github.com/Grimblaz-and-Friends/tradecraft/issues/360) [D-371]. Every stage is held to everything in this file.
