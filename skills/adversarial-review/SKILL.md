...
- **Staffing a panel, or any review role** → `references/roster.md`: the seats and what each looks for, their capability map, what the width rests on, what a review withholds from a cold seat, and the tier rule.
