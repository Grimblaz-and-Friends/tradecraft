...
**Loaded when** you are deciding which home a piece of content belongs in — a skill, an always-on surface, a decision entry, a record. A session writing or revising one document it has already sited does not need it.
