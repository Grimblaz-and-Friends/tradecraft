...
**A ceiling reached is a trigger, not a wall.** A budgeted surface is designed to sit tight, so a full one is what calls for the three moves in that file — never a reason to leave the surface unedited, or to shrink what is being added until it fits.
