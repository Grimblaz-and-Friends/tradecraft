...
**When there is room, bring the owner a few strong pitches and the case against each.** The owner's pick buys the work; the brief settled at pickup determines what it is for. Ratings are the filer's advisory proposal on severity and urgency, not a score the owner must confirm. A pitch left quiet for the policy's window lapses through the explicit fade command, retaining its text and the reason it closed. Closed pitches and review reports are memory, not obligations on the next session.
