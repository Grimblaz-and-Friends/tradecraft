...
**The question is one sentence: the point the two verdicts landed on, and the ruling asked for.** It goes where this practice already sends a decision put to the owner, and **their ruling settles the artifact** — the label states **settled by an owner ruling at the cap**, never the word bare, so no stage inherits it as a reading a seat affirmed. **Where the cap meets a rule below it, the cap governs.** The repeated-point rule's third response has the work proceeding on the recommendation; at the cap it waits, the artifact being unsettled and a draft not built from. And the fresh dispatch an amended brief ordinarily buys is the one thing the cap withholds: where the ruling changes what the change is for, the brief is amended and that same ruling settles the artifact against it. **This is a scheduled arrival inside the unattended stretch rather than a breach of it** — on this record nothing but the owner asking whether a loop was still buying anything has ever ended one, and the cap makes that arrival happen on the second verdict instead of on their noticing. [D-364]
