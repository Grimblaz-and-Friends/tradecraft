...
That is the structural half of what [#260](https://github.com/Grimblaz-and-Friends/tradecraft/issues/260) measured: the surface rose across eleven commits with zero reductions, and eleven of the thirteen commits that shrank a governing surface grew the governing tree in the same commit. Relocation was all the instrument could do.
