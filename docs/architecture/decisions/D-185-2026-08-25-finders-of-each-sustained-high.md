...
**Re-run recipe.** The ledger figures — 64 highs, the retention values, `wiring-falsifier`'s panel count, `operational`'s density — all require the grouping filter, without which none of them reproduces:
