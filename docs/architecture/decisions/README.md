...
| [D-69](D-69-2026-08-18-trial-instrument-and-exception.md) | The trial road's falsifier and evidence stop being ledger-only; a property may be excepted by naming what stands in its place; a failed admission joins the road's re-read trigger | ADR-002:54, ADR-002:56, ADR-002:60, ADR-002:62, ADR-002:70 | — |
