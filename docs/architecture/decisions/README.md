...
| [D-80](D-80-2026-08-19-spikes.md) | Spikes: test a premise before you assert it — one named premise, a throwaway that commits nothing, reported whether it held or fell |
