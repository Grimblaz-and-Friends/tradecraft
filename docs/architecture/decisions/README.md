...
| [D-66](D-66-2026-08-18-boundary-states-scope.md) | The boundary statement states scope rather than prohibiting more; widening it is a re-affirmation the owner gives, and both directions arrive as one batched question at a phase seam | — | — |
