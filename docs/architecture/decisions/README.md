...
| [D-90](D-90-2026-08-20-dispatch-contract.md) | Every dispatch is a shared byte-identical block, then a labeled additive dispatcher's note, then the recipient's own brief; the judge's docket is set by rule, not by the parent |
