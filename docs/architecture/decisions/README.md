...
| [D-102](D-102-2026-08-21-merged-list-is-an-index.md) | The merged list indexes the seat reports and never replaces them: the terminal stage's docket carries anything in a seat's report that no merged finding carries, and content the merge adds that no seat wrote is labeled as the merge's own. The merge keeps the pen and loses the authority — the defect is a summary standing in for its source, not the author's interest, so a clerk would not retire it |
