...
| [D-90](D-90-2026-08-20-dispatch-contract.md) | Every dispatch is a shared byte-identical block with nothing before it, then a labeled additive dispatcher's note, then the recipient's own identity, roster-worded lens brief, and working location; the terminal stage's docket is set by rule, not by the dispatcher |
