...
**Figures re-derived against the tree the review's fix batch produced, which invalidated the pre-fix ones.** Net **−719 characters** across the five surfaces: `skills/filing/SKILL.md` −413, `skills/adversarial-review/references/the-record.md` −279, `docs/cells/records/SKILL.md` −82, `skills/adversarial-review/SKILL.md` −11, and `skills/adversarial-review/references/arbitration.md` **+66** — the one surface that grew, and it grew in the fix batch rather than before it, paying for the two contradictions the review found.

**No cell body here grew, and the one that was over its constant came in under.** `python tools/lint.py` at `69ba49f` and at this branch: `adversarial-review` **9,864 → 9,853** against a constant of 9,855, from 9 over to **2 under**; `filing` 28,435 → 28,022 against 24,158; `records` 8,873 → 8,791, from exactly at its constant to 82 under. The first draft of `Choosing the shape` grew the cell by 96 and three consolidation passes took it back past where it started; the fix batch took it under.
