...
When whether work is worth doing outruns the available evidence, argue it against `docs/values.md` by number; only the owner amends that ranking. Do not admit work whose subject is this practice itself unless it names the Elos or Daemon product harm it answers, because the practice is a means to better product work rather than its own product.
