...
- **Before implementing:** the pre-implementation artifact is a comment on the work's issue, weighted to acceptance criteria and a boundary statement. The owner's reply affirming it is the convergence gate; your own note that they agreed is not the record. (ADR-006 §2)
