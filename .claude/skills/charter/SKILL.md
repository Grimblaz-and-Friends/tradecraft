...
Generated by `tools/roster.py` from `skills/charter/SKILL.md`, which is the `charter` cell's body, and indexes whatever depth sits beside it. Read that file now.
