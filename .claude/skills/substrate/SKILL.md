...
Generated by `tools/roster.py` from `skills/substrate/SKILL.md`, which is the `substrate` cell's body, and indexes whatever depth sits beside it. Read that file now.
