...
Generated by `tools/roster.py` from `docs/cells/board/SKILL.md`, which is the `board` cell's body, and indexes whatever depth sits beside it. Read that file now.
