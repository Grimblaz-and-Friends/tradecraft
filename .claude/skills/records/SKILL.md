...
Generated by `tools/roster.py` from `docs/cells/records/SKILL.md`, which is the `records` cell's body, and indexes whatever depth sits beside it. Read that file now.
