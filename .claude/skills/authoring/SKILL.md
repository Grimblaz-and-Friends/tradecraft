...
Generated by `tools/roster.py` from `skills/authoring/SKILL.md`, which is the `authoring` cell's body, and indexes whatever depth sits beside it. Read that file now.
