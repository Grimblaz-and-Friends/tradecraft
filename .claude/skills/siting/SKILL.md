...
Generated by `tools/roster.py` from `docs/cells/siting/SKILL.md`, which is the `siting` cell's body, and indexes whatever depth sits beside it. Read that file now.
